      ...
      <div className="hero-box">
        <div className="text-box">
          ...
          <animated.h1 style={firstBoot} className="title">
            I'm <br className="break" /> <span className="name">Karan</span>
          </animated.h1>
          <animated.div style={secondBoot}>
            <h2 className="sub-title">I build things for the client-side and serer side of the Web.</h2>
            <p className="intro">
        ...
        <animated.div style={firstBoot} className="image-box">
          <div className="wrapper">
            ...
            <div className="tag-box">
              <p className="tag">
                It's me, Karan! <span className="wave">👋</span>{' '}
              </p>
            </div>
          </div>
        </animated.div>
